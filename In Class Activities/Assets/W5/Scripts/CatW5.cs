...
public class CatW5 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (_flipWSControls)
        {
            translation = Input.GetAxis("Vertical") * _moveSpeed * Time.deltaTime * Vector3.forward * -1;
        }
        else
        {
            translation = Input.GetAxis("Vertical") * _moveSpeed * Time.deltaTime * Vector3.forward;
        }
